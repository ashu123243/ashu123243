...
### 📂 Top Projects
- **NetworkSecurity**: An end-to-end ML project with MongoDB data pipeline, MLflow tracking, and CI/CD deployment on AWS.
- **Student Academic Performance Analysis**: Comprehensive EDA and regression modeling to identify factors affecting student success.
- **Web Designing Workshop**: Developed a responsive e-book store website using HTML, CSS, and JavaScript.
